...
@pytest.mark.asyncio
async def test_get_logs_without_pages(db_session: AsyncSession):
    """
...
@pytest.mark.asyncio
async def test_get_logs_with_pages(db_session: AsyncSession):
    """
...
@pytest.mark.asyncio
async def test_get_logs_mocked(db_session: AsyncSession):
    """
